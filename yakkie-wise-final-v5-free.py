...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        welcomes_premium = ["{} As always, ask me for a Bitcoin fact, or legend. So, what can I help you with?",
                            "{} You know the drill. Ask me for a Bitcoin fact, or legend. So, how can I assist?",
                            "{} It's not like you're new here. I can tell you a Bitcoin fact, or legend. So, how can I help?",
                            "{} Let's get straight to the point: Bitcoin fact, or a legend. So, what can I do for you?",
                            "{} Just ask me for a Bitcoin fact, or a legend. So, how may I help you?"]

        welcomes_free = ["{} To get a random <prosody volume='loud'>Bit</prosody>coin fact you can say, 'Tell me a fact', or to hear a Bitcoin legend just say, 'Tell me a legend'... So, what can I help you with?",
                         "{} To listen to a random <prosody volume='loud'>Bit</prosody>coin fact simply say, 'Tell me a fact', or to hear a Bitcoin legend you can say, 'Tell me a legend'... So, how can I help?",
                         "{} To hear a <prosody volume='loud'>Bit</prosody>coin fact you can say, 'Tell me a fact', or to listen to a Bitcoin legend simply say, 'Tell me a legend'... So, what can I do for you?"]

        portfolio_attr = handler_input.attributes_manager.persistent_attributes

        handler_input.attributes_manager.session_attributes = portfolio_attr

        session_attr = handler_input.attributes_manager.session_attributes

        if not portfolio_attr:
            nice_welcomes = random.choice(welcomes)

            speech = (random.choice(welcomes_free)).format(nice_welcomes)

            session_attr["usage"] = 1
            ...
            speech = (random.choice(welcomes_premium)).format(nice_welcomes_back)
...
class FallbackIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        reprompt = (
                ...
                "some free <prosody volume='loud'>Bit</prosody>coin facts or legends though. "
                "To hear a <prosody volume='loud'>Bit</prosody>coin fact you can say, "
                "'Tell me a fact', or to hear a legend simply say, 'Tell me a legend'. For help, say, "
...
sb = StandardSkillBuilder(table_name="YakkieWise", auto_create_table=True)
